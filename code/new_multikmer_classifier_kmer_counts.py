...
def main(args):
    ...
    # Load data
    all_reads, all_labels, all_freqs, kmer_dict, num_kmers_per_read = utils.read_fastas_from_dirs_CNN(
...
def main(args):
    ...
    all_embs, vec_sizes = utils.load_embeddings_no_torchtext(args.kmer_sizes, args.use_cont, args.use_pos, args.use_seq, args.use_aa, args.cont_dir, args.pos_dir, args.seq_dir, args.aa_dir)
    # Load data
    all_reads, all_labels, kmer_dict, num_kmers_per_read = utils.read_fastas_from_dirs_CNN_freqs(
        [args.girus_dir, args.virus_dir],
        args.read_size,
        args.kmer_sizes,
        args.use_stepk,
